          ...
          >
            <div className="grid gap-3">
              ...
              <Link
                ...
                className="rounded-2xl bg-cyan-500 px-4 py-3 text-center text-sm font-semibold text-white hover:bg-cyan-400"
              >
                Take Attendance
              </Link>

              <Link
                href="/teacher/results/entry"
                className="rounded-2xl bg-green-500 px-4 py-3 text-center text-sm font-semibold text-white hover:bg-green-400"
              >
                Enter Results
              </Link>
              ...
              <Link
                ...
                className="rounded-2xl bg-purple-500 px-4 py-3 text-center text-sm font-semibold text-white hover:bg-purple-400"
              >
                View Classes
              </Link>
